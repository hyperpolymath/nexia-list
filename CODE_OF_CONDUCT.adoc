...
Nexia-List a harassment-free experience for everyone, regardless of age,
...
. The Nexia-List Maintainers will review the report
...
The Nexia-List Maintainers will follow these guidelines in determining
consequences:
...
* Appeals are reviewed by a different Nexia-List Maintainers member than
the original
...
* Open a
https://github.com/hyperpolymath/nexia-list/discussions[Discussion] (for
general questions)
