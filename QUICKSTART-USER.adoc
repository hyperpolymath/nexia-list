...
// Replace nexia-list, Nexia List — See README.adoc for details., just run, Nexia List started successfully. with actuals
...
Nexia List — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./nexia-list-portable
----
...
[source]
----
Nexia List started successfully.
----
